...
<dcterms:W3CDTF>2019-11-21T12:12:06Z</dcterms:W3CDTF>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
        ...
        <Parameter name="StepNumber" type="unsignedInteger" value="3080"/>
        <Parameter name="StepSize" type="float" value="1"/>
        <Parameter name="Duration" type="float" value="3080"/>
        <Parameter name="TimeSeriesRequested" type="bool" value="1"/>
        <Parameter name="OutputStartTime" type="float" value="1520"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Fig. 2D (top)" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="IN" type="Curve2D">
          ...
          <ListOfChannels>
            ...
            <ChannelSpec cn="CN=Root,Model=Heldt2019 - Chlamydomonas multiple-fission cycles,Vector=Compartments[cell],Vector=Metabolites[IN],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="M" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Heldt2019 - Chlamydomonas multiple-fission cycles,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Heldt2019 - Chlamydomonas multiple-fission cycles,Vector=Compartments[cell],Vector=Metabolites[M],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="TF" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Heldt2019 - Chlamydomonas multiple-fission cycles,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Heldt2019 - Chlamydomonas multiple-fission cycles,Vector=Compartments[cell],Vector=Metabolites[TF],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="Fig. 2D (bottom)" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
  ...
  <SBMLReference file="Heldt2019_ChlamydomonasMultipleFission.xml">
